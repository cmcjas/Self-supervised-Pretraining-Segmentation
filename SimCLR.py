...
def pretrain_model(batch_size, learning_rate, weight_decay):
        ...
        initial_dataset = STL10(root=data_path, split='train', download=True, transform=transforms.ToTensor())
        data_loader_for_stats = DataLoader(initial_dataset, batch_size=1000, shuffle=False, num_workers=4)
        ...
        full_dataset = STL10(root=data_path, split='unlabeled', download=True, transform=transform_with_normalization)
        ...
        with open('resnet18_pretrain_stl10_weights.txt', 'a') as f:
            ...
            for epoch in range(40):
                ...
                # if not os.path.exists('./visualisations_stl10'):
                #     os.makedirs('./visualisations_stl10')
                ...
                # plt.savefig(f'./visualisations_stl10/tsne_embeddings_multi_{epoch+1}_{batch_size}_{learning_rate}.png', dpi=300)
                ...
                if avg_validation_loss < best_validation_loss:
                    ...
                    torch.save(model.state_dict(), f"resnet18_pretrain_stl10_weights_{batch_size}_{learning_rate}.pt")
                    epochs_no_improve = 0
