...
def train_model():
    ...
    train_size = int(len(pets_train_orig) * 0.2) # Train at 90%, Val at 10%
    ...
    # Training loop
    with open('resnet18_stl10_segmentation_weights_1.txt', 'a') as f:
        print(f"Training (20%) with {num_epochs} epochs, batch size: {batch_size}, learning rate: 0.001", file=f, flush=True)
        ...
        torch.save(model.state_dict(), "./segmentation_ver3_stl10_8_0.001_model.pth")
