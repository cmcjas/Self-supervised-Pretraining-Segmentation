...
def viz():
    ...
    test_loader = DataLoader(pets_test_orig, batch_size=batch_size, shuffle=False, num_workers=4)
    ...
    model.load_state_dict(torch.load("./segmentation_32_0.2_0.001_model.pth"))
    ...
    for images, masks in test_loader:
        ...
        if highest_iou < iou:
            ...
            # plt.show()
            img_path = os.path.join(base_dir, 'segmentation_32_0.2_0.001.png')
